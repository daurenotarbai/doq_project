    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor_name', models.CharField(blank=True, max_length=50, null=True, verbose_name='Номер телефона')),
                ('from_doctor', models.BooleanField(blank=True, default=False, null=True, verbose_name='От Доктора')),
            ],
            options={
                'verbose_name': 'Заявка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operates_from', models.DateField(verbose_name='Работает с')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('for_child', models.BooleanField(blank=True, default=True, null=True, verbose_name='Детский')),
                ('child_price', models.DecimalField(decimal_places=2, default=Decimal('0'), max_digits=10)),
                ('child_discount', models.PositiveIntegerField(default=0)),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_specialities', to='clinics.doctor')),
                ('speciality', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_specialities', to='clinics.speciality')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procedure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_procedures', to='clinics.procedure')),
            ],
        ),
        migrations.AddField(
            model_name='doctor',
